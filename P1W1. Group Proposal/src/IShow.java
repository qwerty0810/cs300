...
/**
 * Instances of classes that implement this interface represent a single streaming show object that
 * can be stored, sorted, and searched for based on these accessors below.
 */
